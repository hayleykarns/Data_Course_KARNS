...
# Set my working directory and confirmed
setwd("C:/Users/User/Desktop/Data_Course_KARNS")
getwd()
...
# 3.  Createas.data.frame()# 3.  Create a new numeric vector object named "Sepal.Area" which is the product of Sepal.Length and Sepal.Width
